...
async def test_connect():
    ...
    with patch('app.routers.sio_game_list.db_context') as mock_db_context, \
         patch('app.routers.sio_game_list.game_list_events.emit_game_list', new_callable=AsyncMock) as mock_emit_game_list:
