...
from app.services.game_events import emit_players_game, emit_opponents_total_mov_cards
...
def mock_db_session():
    ...
    players = [
        Player(id=1, name="Player1", game_id=1, card_moves=[
            CardMove(id=1, played=False),
            CardMove(id=2, played=True)
        ]),
        Player(id=2, name="Player2", game_id=1, card_moves=[
